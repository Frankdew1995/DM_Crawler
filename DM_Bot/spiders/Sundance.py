...
class DmspiderSpider(scrapy.Spider):
    ...
    # }
    page = 1
    api_url = "https://services.dm.de/websearch/search/pues?type=product&tenant=de_mcr&q=sundance&categoryId=&pageSize=48&sort=relevance&cp={}&productQuery=&initialProductQuery=&hiddenFacets="
